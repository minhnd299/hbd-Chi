...
window.addEventListener('load', () => {
    Swal.fire({
        title: 'Cậu thích bật nhạc nền o ấy nhờ? Nếu có thì ở góc trái có phần chỉnh volumn , cậu có thể chỉnh nếu nhạc to quá nhó',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            // Create and insert volume control
            const volumeControlHTML = `
                <div class="volume-control">
                    <label for="volume">Âm lượng đây nè:</label>
            ...
            volumeSlider.addEventListener('input', function () {
                ...
                volumeValue.textContent = `${Math.round(audioElement.volume * 100)}%`;
            });
        } else {
            animationTimeline();
        }
